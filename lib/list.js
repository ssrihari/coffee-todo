...
(function() {
  ...
  this.List = (function() {
    ...
    function List(board_id, id, name) {
      ...
      this.setUpName = __bind(this.setUpName, this);
      List.COUNT++;
    ...
    List.prototype.setUpName = function(name) {
      this.name = $('<input type="text"/>');
      this.name.keyup(this.save);
      if (name != null) {
        this.name.val(name);
      } else {
        this.name.val(List.DEFAULT_NAME);
      }
      console.log("this is default name :" + this.DEFAULT_NAME);
      console.log("set name is:" + this.name.val());
      return this.name.attr('id', "list-" + this.id + "-name");
    };
